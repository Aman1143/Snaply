...
const ChatRight = ({ currentChat, setOnlineUsers }) => {
  ...
  const handleDocument = (e) => {
    ...
    reader.onload = () => {
      ...
      socket.emit('base64 file', { document: documentData });
    }
  ...
  return (
    <>
                        ...
                        <div class="d-flex align-items-center py-1 header_dabba">
                          ...
                          <div className='header_bar'>
                            ...
                            <div className='header_btn'>
                              ...
                              <button class="btn btn-info btn-lg mr-1 px-3 d-none d-md-inline-block svg boxes" onClick={handleVideo}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-video feather-lg"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg></button>
                      ...
                      <div class="flex-grow-0 py-3 px-4 border-top sender">
                        <div class="input-group">
                          <form onSubmit={handleSubmit} style={{ width: '100%' }}>
                            ...
                            <input type="file" name="image" id="image" hidden onChange={handleDocument} />
                            <label htmlFor="image">
                              <div className="imge">
                                <i class="fas fa-duotone fa-image "></i>
                              </div>
                            </label>
      ...
      <div className="image">
        <img src={URL.createObjectURL(new Blob([document]))} alt="" srcset="" width={20} height={10} />
      </div>
      ...
      {
        isVideo && (
          <Video socket={socket} me={me} sender={seder} />
        )
      }
